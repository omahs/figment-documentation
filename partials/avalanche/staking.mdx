...
Staking AVAX is a simple process. We will collect:
...
2. The response indicates one possible action: `create_Staking_tx`. Use this action to generate a delegation transaction to stake your AVAX.
3. The `create_Staking_tx` action indicates five fields for data collection:
   ...
   - `amount` — The amount of AVAX to be Stakingd.

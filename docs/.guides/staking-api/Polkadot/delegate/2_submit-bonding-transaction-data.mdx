...
- `inputs` &mdash; `object`
  ...
  - `controller_proxy_account_address` &mdash; `string` A proxy account that will sign on behalf of the controller account .
  - `stash_account_address` &mdash; `string` Primary wallet from which DOT will be bonded. Cannot have a zero balance (required).
  - `stash_proxy_account_address` &mdash; `string` A proxy account that will sign on behalf of the controller account .

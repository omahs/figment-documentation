...
slug: /guides/staking-api/polygon/claim-rewards/get-flow-status
---
...
```bash
curl -X GET 'https://matic-slate.datahub.figment.io/api/v1/flows/86d9a004-12b6-4142-90cb-9ade53864e29' \

...
- `inputs` &mdash; `object`
  - `gas_limit` &mdash; `string` Adjust if you wish to limit the possible transaction fee .
  - `gas_price` &mdash; `string` Adjust if you wish to limit the possible transaction fee .

...
slug: /guides/staking-api/polygon/undelegate/submit-claim-transaction-data
---
...
- `inputs` &mdash; `object`
  - `gas_limit` &mdash; `number` Adjust if you wish to limit the possible transaction fee .
  - `gas_price` &mdash; `number` Adjust if you wish to limit the possible transaction fee .

...
- `ethereum.aggregated_staking.delegation.activating` &rarr; `ethereum.staking.delegation.active`
...
- `ethereum.unstaking.*` &mdash; Wildcard for all staking events

- `ethereum.unstaking.delegation.deactivating` &rarr; `ethereum.unstaking.delegation.inactive`

- `ethereum.unstaking.withdrawal_tx.confirmed`

---
title: Staking API Webhooks - Polkadot
sidebar_position: 20
pagination_prev: null
pagination_next: null
collapsed: true
collapsible: true
description: Staking API Webhooks - Polkadot
image: img/logo.svg
keywords: [Staking API Webhooks, Polkadot]
...
<APIMethods
  methods={[
    {
      ...
      response: {
        ...
        body: {
          ...
          created: "2022-08-15T19:11:14.713Z",
          secret:
            "whsec_UmXdnYm3ApdzbdfJmtM1eoD5vohrf4wqKDuuQyRoceTBxDoPKoTmoQTeWogakRKb1hPWEm22LRRDGhrszFoUFPu6NGazsg8yPJz6",
        },
      },
    },
    {
    ...
    },
    {
      ...
      interactive: false,
      response: {
        name: "Get List of Existing Endpoints",
        status: "OK",
        code: 200,
        body: {
          object: "list",
          ...
          data: [
            {
              ...
              enabled: false,
              object: "webhook_endpoint",
              created: "2022-08-15T19:11:35.102Z",
            },
            {
              id: 19,
              event_types: ["*"],
  ...
  network="polkadot"
  proxy=""
  host="polkadot-slate.datahub.figment.io/api/v1/webhook_endpoints"
/>

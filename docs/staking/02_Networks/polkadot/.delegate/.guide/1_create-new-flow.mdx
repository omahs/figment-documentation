...
slug: /staking/polkadot/delegate/create-new-flow
---
...
If you want to skip creating a stash / controller relationship, use the `assign_stash_and_controller_account` action then proceed to <Link to="/staking/polkadot/delegate/submit-nomination-addresses">Submit Nomination Addresses</Link>.

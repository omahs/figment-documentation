...
slug: /staking/polkadot/add-staking-proxy/submit-proxy-data
---
...
- `confirm_add_proxy_tx_by_hash` &mdash; Submit a previously completed transaction hash to continue the flow.

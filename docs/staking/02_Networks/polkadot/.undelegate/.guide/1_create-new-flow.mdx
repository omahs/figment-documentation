...
slug: /staking/polkadot/undelegate/create-new-flow
---
...
**If chilling is required** before unbonding, the Staking API will indicate that you must create a chill transaction. Proceed to [Create Chill Transaction](/staking/polkadot/undelegate/create-unbond-transaction).

**If no chilling is required**, you will be presented with an action to create the unbond transaction. Proceed to [Create Unbond Transaction](/staking/polkadot/undelegate/create-unbond-transaction).

If you want to skip the unbonding process as well, proceed to [Create Withdrawal Transaction](/staking/polkadot/undelegate/create-withdraw-transaction).
...
```json {2-4,7,10,24,38,47,70,81,84,98,112}
{
  ...
  "updated_at": "2023-02-28T21:04:29.799Z"
}
```

---
title: Staking API Webhooks - NEAR
sidebar_position: 20
pagination_prev: null
pagination_next: null
collapsed: true
collapsible: true
description: Staking API Webhooks - NEAR
image: img/logo.svg
keywords: [Staking API Webhooks, NEAR]
...
<APIMethods
  methods={[
    {
      ...
      response: {
        ...
        body: {
          ...
          secret:
            "whsec_xjCyVJZFjPBfmPh3joth3q4xsa9YJnL7vpSDdijfxYdMmHFtMxcXueudsGYgYYkb4wEnFMq18M5yZnUsNMQJkXkS9fXa1tZbc2Xk",
        },
      },
    },
    {
  ...
  network="near"
  proxy=""
  host="near-slate.datahub.figment.io/api/v1/webhook_endpoints"
/>

---
title: Staking API Webhooks - Cardano
sidebar_position: 20
pagination_prev: null
pagination_next: null
collapsed: true
collapsible: true
description: Staking API Webhooks - Cardano
image: img/logo.svg
keywords: [Staking API Webhooks, Cardano]
...
<APIMethods
  methods={[
    {
      ...
      response: {
        ...
        body: {
          ...
          created: "2022-08-15T19:12:28.554Z",
          secret:
            "whsec_9rsvTWXNcgXQZ1bkkHhCFTfuHVB1fp4St4jKydNeCdM3ZsHitPKoGwaDJqvAFzEPnC4sshpYVdBgFnTABhBVMpbQcViU2jgNjZbH",
        },
      },
    },
    {
          ...
          data: [
            {
              ...
              enabled: false,
              object: "webhook_endpoint",
              created: "2022-08-15T19:12:51.601Z",
            },
            {
              id: 21,
              event_types: ["*"],
  ...
  network="cardano"
  proxy=""
  host="cardano-slate.datahub.figment.io/api/v1/webhook_endpoints"
/>

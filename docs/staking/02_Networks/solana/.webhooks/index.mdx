---
title: Staking API Webhooks - Solana
sidebar_position: 20
pagination_prev: null
pagination_next: null
collapsed: true
collapsible: true
description: Staking API Webhooks - Solana
image: img/logo.svg
keywords: [Staking API Webhooks, Solana]
...
<APIMethods
  ...
  network="solana"
  proxy=""
  host="solana-slate.datahub.figment.io/api/v1/webhook_endpoints"
/>

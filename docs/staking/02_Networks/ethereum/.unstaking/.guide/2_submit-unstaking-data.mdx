...
slug: /staking/ethereum/unstaking/submit-unstaking-data
---
...
- If at any point, the broadcast or exit transaction become expired &mdash; the flow state will become `failed`. Refer to the [Unstaking Flow Diagram](/staking/ethereum/unstaking#flow-diagram) for a visual representation.

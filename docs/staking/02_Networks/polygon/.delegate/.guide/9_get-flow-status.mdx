...
slug: /staking/polygon/delegate/get-flow-status-completed
---
...
```bash
curl -X GET 'https://polkadot-slate.datahub.figment.io/api/v1/flows/536921d0-d0f3-4887-8177-69c855cbcce3' \
...
Congratulations, your MATIC delegation is now active and earning rewards!

---
title: Staking API Webhooks - Polygon
sidebar_position: 20
pagination_prev: null
pagination_next: null
collapsed: true
collapsible: true
description: Staking API Webhooks - Polygon
image: img/logo.svg
keywords: [Staking API Webhooks, Polygon]
...
<APIMethods
  ...
  network="polygon"
  proxy=""
  host="matic-slate.datahub.figment.io/api/v1/webhook_endpoints"
/>

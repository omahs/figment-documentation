...
- `cardano.staking.registration.activating` &rarr; `cardano.staking.registration.active`

- `cardano.staking.register_tx.confirmed`

- `cardano.staking.delegation.activating` &rarr; `cardano.staking.delegation.active`
...
- `ethereum.staking.delegation.activating` &rarr; `ethereum.staking.delegation.active`
...
- `ethereum.aggregated_staking.deposits_ready` &mdash; If you had to await provisioning (i.e. On-demand ETH Staking)

- `ethereum.aggregated_staking.aggregated_deposit_tx.confirmed` &mdash; After you give us a signed tx and we broadcast it and it is confirmed onchain

- `ethereum.aggregated_staking.delegation.activating` &mdash; One or many times, as each group of your validators becomes active

- `ethereum.staking.delegation.active` &mdash; Once all validators are active

#### Aggregated Unstaking

- `ethereum.aggregated_unstaking.*` &mdash; Wildcard for all aggregated unstaking events

- `ethereum.aggregated_unstaking.in_queue` &mdash; Validator(s) have joined the exit queue

- `ethereum.aggregated_unstaking.exited_queue` &mdash; Validator(s) have left the exit queue

- `ethereum.aggregated_unstaking.withdrawal_done` &mdash; Once all validators are successfully withdrawn

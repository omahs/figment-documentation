...
| Cardano   | <Link to="https://preprod.cardanoscan.io/pools">https://preprod.cardanoscan.io/pools</Link>                                     |
...
| Solana    | <Link to="https://explorer.solana.com/?cluster=devnet">https://explorer.solana.com/?cluster=devnet</Link>                       |
...
| Cardano   | <Link to="https://docs.cardano.org/cardano-testnet/tools/faucet">https://docs.cardano.org/cardano-testnet/tools/faucet</Link>                                                                                                     |

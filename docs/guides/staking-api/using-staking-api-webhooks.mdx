---
title: Using Staking API Webhooks
---
...
- Follow the instructions in <Link to="https://ngrok.com/docs/getting-started">Getting Started with ngrok</Link>

Once ngrok is installed, you can forward your locally running server by running the following command in a terminal:

...
- `max_shares_to_burn` &mdash; The maximum number of shares of the delegation to be burned. If the exchange rate results in more shares being burned, the transaction will fail (optional).
- `max_slippage_percentage` &mdash; The maximum slippage you are willing to accept (optional).
- `gas_limit` &mdash; Adjust gas limit for the transaction (optional).
- `gas_price` &mdash; Adjust gas price for the transaction (optional).

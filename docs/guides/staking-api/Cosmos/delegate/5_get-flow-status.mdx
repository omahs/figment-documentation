...
slug: /guides/staking-api/cosmos/delegate/get-flow-status-completed
---
...
```bash
curl -X GET 'https://cosmos-slate.datahub.figment.io/api/v1/flows/1d823c7f-be8a-430e-85cf-7269206cd867' \
